...
public:
	...
	virtual void Save(ofstream& OutFile, ObjectType& type, int& cellNum) = 0;	// Saves the GameObject parameters to the file
	
	virtual void Open(ifstream& OutFile, ObjectType& type, Grid* gPtr) = 0;
